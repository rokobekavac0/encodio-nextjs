  ...
  return (
    <>
      ...
      <div className={css(tw`relative`)}>
        <Spinner show={showSpinner} className={css(tw`absolute top-4 text-green-500 right-0`, spinnerClassName)} />
        <textarea
          id={id}
          value={value}
          readOnly={isReadOnly}
          ...
          className={css(
            tw`shadow resize-none appearance-none tracking-normal mt-2 py-2 h-32 md:h-40 border bg-black w-full text-white font-mono mb-3 rounded-none`,
